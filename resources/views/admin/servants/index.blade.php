                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">المـنـــاديــــــــــب</h4>
                                    ...
                                    <table class="table text-md-nowrap" id="example1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-20p border-bottom-0">عنوان المندوب </th>
                                                <th class="wd-15p border-bottom-0">تليفون المندوب</th>
                                        ...
                                        <tbody id="tBody">
                                            ...
                                            @foreach ($servants as $servant)
                                                <tr class="servantRow{{ $servant->id }}">
                                                    <td>{{ $x++ }}</td>
                                                    <td>{{ $servant->name }}</td>
                                                    <td>{{ $servant->adress }}</td>
                                                    <td>{{ $servant->phone }}</td>
                                                    <td>
...
@section('js')
	...
	<script>
		$(document).on('click','#makeCreateServant',function(e)
		{
			...
			//Get Form Data
			var formData = new FormData($('#createٍServant')[0]);            

			$.ajax(
			{
				type: 'post',
				url: "{{route('servants.store')}}",
				data: formData,
				processData: false,
				contentType: false,
				cache: false,
	...
	<script>
		$(document).on('click','.makeDeleteServant',function(e)
		{
			e.preventDefault();
