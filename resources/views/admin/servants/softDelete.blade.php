                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">المناديب المحذوفة</h4>
                                            ...
                                            @foreach ($servants as $servant)
                                                <tr class="servantRow{{ $servant->id }}">
                                                    ...
                                                    <div class="btn-icon-list">
                                                        ...
                                                        <a href="" class="makeRestoreServant" servant_id="{{ $servant->id }}">
...
@section('js')
	...
	<script>
		$(document).on('click','.makeRestoreServant',function(e)
		{
			e.preventDefault();
