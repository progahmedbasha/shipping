                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">الموردين المحذوفة</h4>
                                                ...
                                                <tr class="supplierRow{{ $supplier->id }}">
                                                    ...
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            <a href="" class="makeRestoreSupplier" supplier_id="{{ $supplier->id }}">
...
@section('js')
	...
	<script>
		$(document).on('click','.makeRestoreSupplier',function(e)
		{
			e.preventDefault();
