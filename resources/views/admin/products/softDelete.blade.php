                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">الشحنات المحذوفة</h4>
...
<!--                             <p class="tx-12 tx-gray-500 mb-2">Example of Valex Simple Table. <a href="">Learn more</a></p>
 -->                        </div>
                        ...
                        {{--  START GET FLASH MESSAGES   --}}
                            ...
                            <div class="row mr-2 ml-2" id="successMessg" style="display: none">
                                <button type="text" class="btn btn-lg btn-block btn-outline-success mb-2">
                                        تم التفعيل بنجاح
                                </button>
                            </div>

                            <div class="row mr-2 ml-2" id="errorMessage0" style="display: none">
                                <button type="text" class="btn btn-lg btn-block btn-outline-danger mb-2">
                                    هذه الشحنة تم تسليمها و لا يمكن اضافتها للمخزن
                                </button>
                            </div>
...
@section('js')
	...
	<script>
		$(document).on('click','.makeRestoreProduct',function(e)
		{
			e.preventDefault();
