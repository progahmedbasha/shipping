                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">المدن المحذوفـــــة</h4>
                                            ...
                                            @foreach ($cities as $city)
                                                <tr class="cityRow{{ $city->id }}">
                                                    ...
                                                    <div class="btn-icon-list">
                                                        ...
                                                        <a href="" class="makeRestoreCity" city_id="{{ $city->id }}">
...
@section('js')
	...
	<script>
		$(document).on('click','.makeRestoreCity',function(e)
		{
			e.preventDefault();
