                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">الحالات المحذوفة</h4>
 ...
 -->                        </div>
                        ...
                        {{--  END GET FLASH MESSAGES   --}}
                            ...
                            <div class="table-responsive">
                                            ...
                                            @foreach ($allStatus as $status)
                                                <tr class="statusRow{{ $status->id }}">
                                                    ...
                                                    <div class="btn-icon-list">
                                                        ...
                                                        <a href="" class="makeRestoreStatus" status_id="{{ $status->id }}">
                                ...
                                @else
                                    <h1 class="text-center">No Status</h1>
                                @endif
                            </div>
                        </div>
                    </div>
...
@section('js')
	...
	<script>
		$(document).on('click','.makeRestoreStatus',function(e)
		{
			e.preventDefault();
